<template>
        ...
        <div class="row">
          <div class="col-5">
            <div class="input-group mb-3">
              <span class="input-group-text" id="basic-addon1" style="width: 30%"
                >Kod</span
              >
              <input
                type="text"
            ...
            <div class="row">
              <div class="col">
                <Dropdown
                  ...
                  :options="getProductSupplierList"
                  filter
                  :disabled="form_status"
                  aria-describedby="basic-addon1"
              ...
              <div class="col">
                <div class="input-group mb-3">
                  ...
                  <input
                    ...
                    :disabled="form_status"
                    aria-describedby="basic-addon1"
                    v-model="products.alisFiyati_Tl"
                  />
                </div>
              </div>
              ...
              <div class="col">
                <div class="input-group mb-3">
                  ...
                  <input
                    ...
                    :disabled="form_status"
                    aria-describedby="basic-addon1"
                    v-model="products.satisFiyati"
                    @input="
                      products.satisFiyati = $filters.formatPoint($event.target.value)
                    "
                  />
                </div>
              </div>
              ...
              <div class="col-4">
                <span class="p-float-label">
                  <InputText
                    ...
                    id="amount"
                    :disabled="form_status"
                    v-model="products.miktar"
                    @input="tonajChange($event)"
                  />
              ...
              <div class="col-4">
                <span class="p-float-label">
                  <InputText
                    ...
                    id="crate"
                    :disabled="form_status"
                    v-model="products.adet"
                    @input="products.adet = $filters.formatPoint($event.target.value)"
                  />
              ...
              <div class="col-4">
                <span class="p-float-label">
                  <InputText
                    ...
                    :disabled="form_status"
                    aria-describedby="basic-addon1"
                    v-model="products.siraNo"
                    @input="products.siraNo = $filters.formatPoint($event.target.value)"
                  />
              ...
              <div class="col-4">
                <span class="p-float-label">
                  <InputText
                    ...
                    :disabled="form_status"
                    aria-describedby="basic-addon1"
                    v-model="products.ozelMiktar"
                    @input="
                      products.ozelMiktar = $filters.formatPoint($event.target.value)
                    "
                  />
              ...
              <div class="col-4">
                <span class="p-float-label">
                  <InputText
                    ...
                    :disabled="form_status"
                    aria-describedby="basic-addon1"
                    v-model="products.ton"
                    @input="products.ton = $filters.formatPoint($event.target.value)"
                  />
            ...
            <button
              ...
              @click="workmanship_form = true"
              v-if="workmanshipButton"
              :disabled="workmanship_disabled"
            >
              İşçilik
            </button>
          </div>
              ...
              <div class="col-6">
                <div class="form-floating">
                  <textarea
                    ...
                    v-model="products.musteriAciklama"
                  ></textarea>
              ...
              <div class="col-6">
                <div class="form-floating">
                  <textarea
                    ...
                    id="floatingTextarea"
                    style="height: 150px; padding-top: 35px"
                    v-model="products.uretimAciklama"
                  ></textarea>
              ...
              <div class="">
                <div class="input-group mb-3">
                  ...
                  <input
                    ...
                    aria-describedby="basic-addon1"
                    v-model="products.miktar"
                    @input="products.miktar = $filters.formatPoint($event.target.value)"
                  />
                </div>
              </div>
              <div class="">
  ...
  <Dialog
    v-model:visible="product_card_form"
    header="Ürünler"
    modal
    :closeOnEscape="false"
    :style="{ width: '100vw' }"
  ...
  <Dialog
    v-model:visible="workmanship_form"
    header="İşçilik"
    modal
    :closeOnEscape="false"
    :style="{ width: '100vw' }"
  >
    <workmanship
      :orderNo="getProductionsDetailModel.siparis.siparisNo"
      :productId="products.urunKartId"
    />
  </Dialog>
</template>
<script>
...
export default {
  ...
  methods: {
    tonajChange(event) {
      ...
      if (
        ...
        if (this.selectedUnit.id == 3) {
          ...
          this.products.ton = (
            (coefficient * 10 * mt * parseFloat(this.products.kenar.replace(",", "."))) /
            1000
          ).toFixed(3);
        } else {
          this.products.ton = 0;
      ...
      this.products.ozelMiktar = this.oM2Change(
        this.products.en,
        this.products.boy,
        event.target.value,
    ...
    product_select_item(event) {
      // @ts-ignore
      this.products = this.getProductionsDetailModel.siparisUrunler.find(
        (x) => x.id == event.data.id
      );
      this.productCardSelected(
        this.getCardList.find((x) => x.id == event.data.urunKartId)
      );
      this.selectedSupplier = this.getProductSupplierList.find(
        (x) => x.id == event.data.tedarikciId
      );
      this.selectedUnit = this.getProductUnitList.find(
        (x) => x.id == event.data.urunBirimId
      );
    ...
    updateForm() {
      ...
      if (!this.products.tedarikciId) {
        ...
        const index = this.findIndex(
          this.products.id,
          this.getProductionsDetailModel.siparisUrunler
        );
        // @ts-ignore
        ...
        if (!this.getProductionsNewButton) {
          // @ts-ignore
          const result = this.getProductionsDetailModel.urunlerDegisenler.filter(
            (x) => x.id == this.products.id
          );
          if (result.length > 0) {
            const index = this.findIndex(
              this.products.id,
