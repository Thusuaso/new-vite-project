<template>
    ...
    <div v-if="!getMobile">
            ...
            <div class="col">
                <span class="p-float-label">
                        <AutoComplete id="tedarikci" v-model="tedarikci" :suggestions="filterTedarikciList"
                            @complete="aramaTedarikci($event)" field="tedarikciadi" :dropdown="true" @item-select="tedarikciDegisim"
                            @input="tedarikciler">
            ...
            <div class="col">
                <span class="p-float-label">
                        <AutoComplete id="teslimTur" v-model="teslimTur" :suggestions="filterTeslimTurList"
                            @complete="aramaTeslimTur($event)" field="tur" :dropdown="true" @item-select="teslimTurDegisim">
                            <template #items="slotProps">
                                <div class="p-clearfix p-autocomplete-brand-item">
                                    <div>{{ slotProps.tur }}</div>
                                </div>
        ...
        <div class="row m-auto mt-3">
            <div class="col">
                <span class="p-float-label">
                        <Textarea id="m4" @input="metinDegisim($event)" v-model="madde4" rows="3" cols="50" />
                        <label for="m4">M4</label>
                    </span>
            </div>
            <div class="col">
                <span class="p-float-label">
                    <Textarea id="m5" v-model="madde5" @input="metinDegisim($event)" rows="3" cols="50" />
        ...
        <div class="row m-auto mt-3">
            <div class="col">
                <DataTable style="font-size:85%;" v-model:value="urunList" v-model:selection="selectUrun"
                    ...
                    <Column field="alisFiyati" header="Alış Fiyatı" bodyStyle="text-align:center;">
                        <template #body="slotProps">
        ...
        <div class="row m-auto mt-3">
            <div class="col" style="margin-left: 65px">
                <button icon="fas fa-file-excel" @click="excel_cikti_click" style="
            margin: 20px;
            height: 50px;
            width: 150px;
        ...
        " >ISF-Excel</button>
            ...
            <div class="col">
                <button icon="fas fa-file-pdf" @click="download"
    ...
    <div v-if="getMobile">
        <div class=" m-auto mt-3">
            <div class=" mb-3">
                <span class="p-float-label">
                        <AutoComplete class="w-100" id="tedarikci" v-model="tedarikci" :suggestions="filterTedarikciList"
                            @complete="aramaTedarikci($event)" field="tedarikciadi" :dropdown="true" @item-select="tedarikciDegisim"
                            @input="tedarikciler">
                            <template #items="slotProps">
                                <div class="p-clearfix p-autocomplete-brand-item">
            ...
            <div class="mb-3">
                <span class="p-float-label">
                    <AutoComplete id="faturaTur" class="w-100" v-model="faturaTur1" :suggestions="filterFaturaTurList"
                        @complete="aramaFaturaTur($event)" field="tur" :dropdown="true" @item-select="faturaTurDegisim">
                        <template #items="slotProps">
                            <div class="p-clearfix p-autocomplete-brand-item">
                                <div>{{ slotProps.tur }}</div>
            ...
            <div class="mb-3">
                <span class="p-float-label">
                    <Calendar id="sipTarih" class="w-100" v-model="teslimTarihi" :showIcon="true" dateFormat="dd/mm/yy"
                        @date-select="siparisTarihiDegisim" />
                    <label for="sipTarih">Tarih</label>
                </span>
            </div>
            <div class="mb-3">
                <span class="p-float-label">
                        <AutoComplete id="teslimTur" class="w-100" v-model="teslimTur" :suggestions="filterTeslimTurList"
                            @complete="aramaTeslimTur($event)" field="tur" :dropdown="true" @item-select="teslimTurDegisim">
                            <template #items="slotProps">
                                <div class="p-clearfix p-autocomplete-brand-item">
                                    <div>{{ slotProps.tur }}</div>
            ...
            <div class="">
                <div class="field-checkbox">
                        <Checkbox style="margin-right:8px;" inputId="city1" name="city" v-model="is_two_isf_form" :binary="true" />
        ...
        <div class=" m-auto mt-3">
            <div class="ml-3">
                <span class="p-float-label">
                        <Textarea class="w-100 ml-3" id="m4" @input="metinDegisim($event)" v-model="madde4" rows="4"  />
                        <label for="m4">M4</label>
                    </span>
            </div>
            <div class="ml-3">
                <span class="p-float-label">
                    <Textarea class="w-100 ml-3" id="m5" v-model="madde5" @input="metinDegisim($event)" rows="4"  />
                    <label for="m5">M5</label>
                </span>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...mapState(useProductionsStore, [
            'getProductsDetailSupplierList',
            'getProductsSupplierDeliveryList',
            'getProductsSupplierInvoiceList',
    ...
    mounted() {
        ...
        this.emitter.on("suppliers", (data) => {
            ...
            for (let item of data) {
                if (this.controlTedarikciList(item.tedarikciAdi) != false) {
                    this.getProductsDetailSupplierList.push({ tedarikciadi: item.tedarikciAdi });
                }
            }
        });
        productionsService.getSiparicIcSiparis().then((data) => {
        ...
        productionsService
            .getTedarikciUrunAyrintiListYukle(this.po)
            .then((data) => {
                this.siparisUrunleryeni = data.tedarikciUrunliste;
                this.getProductsDetailSupplierList = data.tedarikciliste;
            });
    },
    ...
    methods: {
        ...
        controlTedarikciList(event) {
            for (let item of this.getProductsDetailSupplierList) {
            ...
            productionsService
                ...
                .then((res) => {
                    if (res.status) {
                        ...
                        link.href = this.getLocalServiceUrl + "islemler/dosyalar/pdfciktim";
        ...
        dosya() {
            this.urunList[0].kullaniciAdi = localStorage.getItem('username');
            // this.urunList[0].kullaniciAdi = this.$store.getters.getUser

            productionsService.setIcSiparisDosyaKayit(this.urunList[0]).then((veri) => {
                console.log(veri);
            });
        },
        formatDecimal(value) {
        ...
        faturaOtomatikDosyaGonderme(event) {
            ...
            this.urunList[0].kullaniciAdi = localStorage.getItem('username');
            const evrak = this.tedarikci.tedarikciadi + "-" + this.po + ".pdf";
        ...
        faturaDosyaGonder(event) {
            if (event.size > 1000000) {
                ...
                if (this.is_two_isf_form == false) {
                    ...
                    const evrak =
                        this.tedarikci.tedarikciadi + "-" + this.po + " -2" + ".pdf";
                    fileService.faturaDosyaGonder(event, 3, evrak).then((data) => {
                        console.log(data);
                        const bilgi = {
                            evrak: this.tedarikci.tedarikciadi + "-" + this.po + " -2" + ".pdf",
                            siparisno: this.po,
                            kullaniciAdi: localStorage.getItem('username'),
                            kullaniciId:localStorage.getItem('userId')
                        };
        ...
        siparisTarihiDegisim() {
            this.teslimTarihi = localDateService.getDateString(this.teslimTarihi);
        ...
        aramaTeslimTur(event) {
            setTimeout(() => {
                ...
                if (event.query.length === 0) {
                    result = [...this.getProductsSupplierDeliveryList];
                } else {
                    result = this.getProductsSupplierDeliveryList.filter((ted) => {
        ...
        aramaFaturaTur(event) {
            setTimeout(() => {
                let result;
                if (event.query.length === 0) {
                    result = [...this.getProductsSupplierInvoiceList];
                } else {
                    result = this.getProductsSupplierInvoiceList.filter((ted) => {
            ...
            productionsService
                ...
                .then((res) => {
                    if (res.status) {
                        const link = document.createElement("a");
                        link.href =
                            this.getLocalServiceUrl + "siparisler/dosyalar/IcSiparisExcelCikti";
        ...
        aramaTedarikci(event) {
            setTimeout(() => {
                if (event.query.length === 0) {
                    this.filterTedarikciList = [...this.getProductsDetailSupplierList]
                } else {
                    this.filterTedarikciList = this.getProductsDetailSupplierList.filter((ted) => {
        ...
        teslimTurDegisim() {
            ...
            for (let key in this.getProductsSupplierDeliveryList) {
                const data = this.getProductsSupplierDeliveryList[key];
        ...
        faturaTurDegisim() {
            ...
            for (let key in this.getProductsSupplierInvoiceList) {
                const data = this.getProductsSupplierInvoiceList[key];
