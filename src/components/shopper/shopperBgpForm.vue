    ...
    <div v-if="!getMobile">
            ...
            <div class="col">
                <div class="input-group mb-3">
                    <span span class="input-group-text" id="basic-addon1">Customer</span>
                    <input type="text" class="form-control" aria-describedby="basic-addon1" v-model="getShopperBgpModel.customer">
                </div>
            </div>
            <div class="col">
                <div class="input-group mb-3">
                    <span span class="input-group-text" id="basic-addon1">Company</span>
        ...
        <div class="row m-auto mt3">
            <div class="col">
                <AutoComplete class="w-100" v-model="selectedCountry" dropdown :suggestions="filteredCountryList" placeholder="Select a Country" optionLabel="ulkeAdi" @complete="searchCountry($event)" @item-select="countrySelected($event)" />
            </div>
            <div class="col">
                <div class="input-group mb-3">
                    <span span class="input-group-text" id="basic-addon1">Phone</span>
                    <input type="text" class="form-control" aria-describedby="basic-addon1" v-model="getShopperBgpModel.phone">
                </div>
            </div>
            <div class="col">
                <div class="input-group mb-3">
                    <span span class="input-group-text" id="basic-addon1">Salesman</span>
        ...
        <div class="row m-auto mt-3">
            <div class="col">
                <button type="button" class="btn btn-success w-100" @click="bgpProcess">Save</button>
            </div>
        ...
        <div v-if="getMobile">
            ...
            <div class=" m-auto mt3">
                <div class="">
                    <AutoComplete class="w-100 mb-3" v-model="selectedCountry" dropdown :suggestions="filteredCountryList" placeholder="Select a Country" optionLabel="ulkeAdi" @complete="searchCountry($event)" @item-select="countrySelected($event)" />
                </div>
                <div class="">
                    <div class="input-group mb-3">
                        <span span class="input-group-text" id="basic-addon1">Phone</span>
            ...
            <div class=" m-auto mt-3">
                <div class="">
                    <button type="button" class="btn btn-success w-100 mb-3" @click="bgpProcess">Save</button>
                </div>
