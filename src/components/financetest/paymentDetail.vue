<template>
                ...
                <div class="row m-auto mt-3">
                    ...
                    <div class="col">
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px;padding-top:35px;" v-model="getFinanceTestDetailPaymentList.musteri_model.aciklama"></textarea>
    ...
    <div v-if="getMobile">
            ...
            <div class="">
                ...
                <div class=" m-auto mt-3">
                    <div class="">
                        <Calendar class="w-100 mb-3" v-model="p_date" @date-select="paymentDateSelected($event)" dateFormat="dd/mm/yy"/>
                    </div>
                    <div class="">
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Bakiye</span>
        ...
        <div class=" m-auto mt-3">
            <div class="">
                <button type="button" class="btn btn-success w-100 mb-3" @click="save" :disabled="save_form_disabled">Kaydet</button>
            </div>
            <div class="">
                <button type="button" class="btn btn-warning w-100 mb-3" @click="update" :disabled="form_disabled">Güncelle</button>
            </div>
            <div class="">
                <button type="button" class="btn btn-danger w-100 mb-3" @click="deleteForm" :disabled="form_disabled">Sil</button>
            </div>
        </div>
    </div>
