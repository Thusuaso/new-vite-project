<template>
        ...
        >
          ...
          <Column field="advanced_payment" header="Prepayment">
            <template #body="slotProps">
              <div
                :style="{
                  backgroundColor: slotProps.data.advanced_payment ? 'red' : '',
                  color: slotProps.data.advanced_payment ? 'white' : '',
                }"
              >
          ...
          <Column header="balanced" sortable="">
            <template #body="slotProps">
              <div
                :style="{
                  backgroundColor:
                    slotProps.data.balanced < -8
                      ...
                      ? 'green'
                      : '',
                  color: slotProps.data.balanced < -8 ? 'white' : 'white',
                }"
              >
                {{ $filters.formatPrice(slotProps.data.balanced) }}
              </div>
            </template>
            <template #footer>
    ...
    >
      ...
      <Column field="total " header="Balance (Including Production)">
        <template #body="slotProps">
          <div
            :style="{
              backgroundColor: slotProps.data.total < -8 ? 'green' : '',
              color: slotProps.data.total < -8 ? 'white' : 'black',
            }"
          >
            {{ $filters.formatPrice(slotProps.data.total) }}
          </div>
  ...
  <Dialog
    v-model:visible="finance_test_form"
